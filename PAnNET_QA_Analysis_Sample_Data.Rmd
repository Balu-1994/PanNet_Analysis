...
expression_dir = "/Users/balu/Desktop/PanNet_Analysis"
...
# metaData
sampleMetaData <- df.desiDNARNASample
...
sampleMetaData = left_join(sampleMetaData, init_reads, by = "name",
                           suffix = c(".old", "")) %>%
...
sampleMetaData = left_join(sampleMetaData, trim_reads, by = "Sample_UID",
                           suffix = c(".old", "")) %>% 
  dplyr::select(!ends_with("old"))
...
sampleMetaData = left_join(sampleMetaData, filt_reads, 
                           by = "Sample_UID", suffix = c(".old", "")) %>% 
  dplyr::select(!ends_with("old")) %>% 
...
sampleMetaData = left_join(sampleMetaData, STAR_reads, 
                           by = "Sample_UID", suffix = c(".old", "")) %>% 
  dplyr::select(!ends_with("old")) %>% 
...
sampleMetaData = left_join(sampleMetaData, count_reads, 
